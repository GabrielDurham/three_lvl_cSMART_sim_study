...
es_lc_table_fits <- list(
  ...
  "$\\delta=0.8$ ($n=40$)"=
    list(fit_data=es_inference_output[["sim_ASIC-Eff-Size-y-n:2-ES:0.8"]][["fit_1"]][["EOS"]],
              filter_statement=comp_filter),
  "$\\delta=1.2$ ($n=18$)"=
    list(fit_data=es_inference_output[["sim_ASIC-Eff-Size-y-n:2-ES:1.2"]][["fit_1"]][["EOS"]],
              filter_statement=comp_filter)
)
...
```{r Create Working Variance Misspecification Tables}
