...
a three-level clustered SMART with more than three time points
...
Execute_Driver_File_Main_Alt(alt_driver=full_driver, 
                             do_par=TRUE, 
                             n_threads=5,
                             path=data_path, 
...
inference_output <- 
  Conduct_Inference_for_Driver_Run_Alt(path=paste0(data_path, export_folder_name))
